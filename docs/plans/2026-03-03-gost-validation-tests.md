...
- [ ] Добавить тестовые вектора M1 (63 байта: "012345678901234567890123456789012345678901234567890123456789012") и M2 (72 байта binary) из RFC 6986 / ГОСТ Р 34.11-2012 для Streebog-256 и Streebog-512.
- [ ] Добавить тест на длинное сообщение (повторение паттерна 1000+ раз).
- [ ] Добавить тест на инкрементальное хеширование совпадающее с одноразовым Sum.
- [ ] Запустить `go test ./streebog/...` - все тесты должны пройти.
